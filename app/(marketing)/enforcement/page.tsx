    ...
    <LegalLayout title="举报与处罚细则" updated="2026-08-24">
      ...
      <section className="legal-section">
        ...
        <ul>
          ...
          <li>飞书反馈表单：提交情况说明与举报材料（入口见官网常见问题区）。</li>
        </ul>
      </section>
      ...
      <section className="legal-section">
        <h2>七、申诉机制</h2>
        <p>如你认为处置有误，可在收到处置通知后通过飞书反馈表单提交申诉，说明理由并提供证据。我们将在合理期限内复核并回复。申诉不影响依法配合执法机关的义务。</p>
      </section>
      ...
      <section className="legal-section">
        ...
        <ol>
          <li><b>投诉</b>：通过飞书反馈表单提交投诉，说明被侵权内容、权利归属及侵权事实，并附权利证明（如著作权登记、创作底稿、授权文件等）；</li>
