...
export const discoveryItems: DiscoveryItem[] = [
  ...
  { id: "d12", type: "学习资源", title: "Notion 知识库搭建指南", description: "一套从零搭建个人知识库的图文教程，涵盖结构设计、模板与日常维护。", note: "花了两周把自己的知识库重构成了这个结构，效率提升明显，分享出来。", author: "我的账户", publishTime: "2h", views: 36, likes: 8, comments: 1, tags: ["Notion", "知识库", "效率"], source: "我的账户", origin: "个人博客", url: "https://example.com/notion-guide", kind: "doc" },
  { id: "d13", type: "商业推广", title: "AI 写作助手限时优惠", description: "面向内容创作者与自媒体人的 AI 写作助手，本月限时 7 折。", note: "自己用了三个月的写作助手，出稿效率确实高。通过我的链接订阅双方都得积分。", author: "我的账户", publishTime: "5h", views: 88, likes: 6, comments: 3, tags: ["AI", "写作", "优惠"], source: "我的账户", origin: "活动平台", commercial: true, promoType: "积分活动", commission: "订阅双方得 200 积分", url: "https://example.com/ai-writer", kind: "link" },
];
